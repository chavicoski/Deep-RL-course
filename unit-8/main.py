...
from lib.hugging_face import package_to_hub
from lib.ppo import Agent, make_env
...
def parse_args():
    ...
    parser.add_argument(
        "--env-id", type=str, default="LunarLander-v2", help="the id of the environment"
    )
    parser.add_argument(
        "--total-timesteps",
        type=int,
    ...
    parser.add_argument(
        "--repo-id",
        type=str,
        default="chavicoski/PPO-CleanRL-LunarLander-v2",
...
if __name__ == "__main__":
    ...
    # Create a virtual display to render the video
